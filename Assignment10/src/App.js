...
function App() {
  ...
  async function getWeatherData() {
    try {
      ...
      let resp = await axios.get(`http://api.openweathermap.org/geo/1.0/direct?q=${city}&limit=5&appid=cdda43558d59fdc770a48bc3b4ae8d5e`);
      const lat = resp.data[0].lat;
      const long = resp.data[0].lon;

      const apiKey = 'cdda43558d59fdc770a48bc3b4ae8d5e';
